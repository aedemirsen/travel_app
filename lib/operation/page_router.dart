...
class PageRouter {
  ...
  //1 - down to up
  static Offset downToUp = Offset(0.0, 1.0);
  //2 - up to down
  static Offset upToDown = Offset(0.0, -1.0);
  //3 - left to right
  static Offset leftToRight = Offset(-1.0, 0.0);
  //4 - right to left
  static Offset rightToLeft = Offset(1.0, 0.0);
